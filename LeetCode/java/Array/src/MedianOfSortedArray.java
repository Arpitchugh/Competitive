public class MedianOfSortedArray {
    ...
    private static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        if (l1 % 2 == 0 && l2 % 2 == 0) {
            return (nums1[ml1] + nums1[ml1 + 1] + nums2[ml2] + nums2[ml2 + 1]) / 4.0;
        } else if (l1 % 2 == 0 && l2 % 2 != 0) {
            return (nums1[ml1] + nums1[ml1 + 1] + nums2[ml2]) / 3.0;
        } else if (l1 % 2 != 0 && l2 % 2 == 0) {
            return nums1[ml1] + (nums2[ml2] + nums2[ml2 + 1]) / 3.0;
        } else {
            return (nums1[ml1] + nums2[ml2]) / 2.0;
        }
    }
